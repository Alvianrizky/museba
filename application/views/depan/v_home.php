...
<head>
    ...
    <title>SMA Muhammadiyah Sewon</title>
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active">
                    <img class="d-block" src="<?php echo base_url().'theme/images/aw.jpg'?>" alt="First slide">
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            <h1>Selamat datang di Website <br>SMA MUHAMMADIYAH SEWON</h1>
                            <div class="slider-btn">
                                <a href="<?php echo site_url('pendaftaran');?>" class="btn btn-primary">DAFTAR SEKARANG</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="d-block" src="<?php echo base_url().'theme/images/aw-2.jpg'?>" alt="Second slide">
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            ...
                            <div class="slider-btn">
                                <a href="<?php echo site_url('guru');?>" class="btn btn-primary">Learn more</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="d-block" src="<?php echo base_url().'theme/images/aw-3.jpg'?>" alt="Third slide">
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            ...
                            <div class="slider-btn">
                                <a href="<?php echo site_url('galeri');?>" class="btn btn-primary">Learn more</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="welcome_about">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-7">
                <li class="list-group-item active bg-info text-dark">Sambutan Kepala Sekolah</li>
                <div class="list-group-item" text align="justify"><p>SMA Muhammadiyah Sewon terletak di Jalan Imogiri Barat Km. 7,5 Dusun Mredo Bangunharjo Sewon Bantul Daerah Istimewa Yogyakarta. 
                Dengan lokasi yang jauh dari kebisingan memberikan suasana proses belajar mengajar yang cukup nyaman dan tenang. Ditambah dengan rindangnya pepohonan dihalaman sekolah serta ditunjang sarana olahraga dan tempat ibadah yang menyenangkan untuk menuntut ilmu.
                Dengan didukung oleh para guru yang telah bersertifikat dan berdedikasi tinggi SMA Muhammadiyah Sewon siap menghantarkan siswa didiknya untuk berprestasi baik secara akademis maupun non akademis.
                Sebagai salah satu unit pelaksana teknis dalam bidang pendidikan di Kabupaten Bantul, SMA Muhammadiyah Sewon siap mendukung program Kemendikbud dan bertanggung jawab untuk turut mengingkatkan kualitas pendidikan.
                </p></div>
                </div>
                <div class="col-md-5">
                <div class="card" style="width: 18rem;">
                  <img src="<?php echo base_url().'theme/images/sambutan.png'?>" class="img-fluid" alt="#">
                  <div class="card-body" text align="center">
                    <div class="card-text" ><b>H. Kurniawan Indaryatna, S.T</b>
                        <br>Kepala Sekolah <br>SMA Muhammadiyah Sewon
                  </div>
                </div>
