        ...
        <div class="row">
            <div class="col-md-12">
                <div class="contact-form">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 contact-option bg-info">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 bg-info">
                            <div class="contact-address">
                                ...
                                <div class="contact-details">
                                    ...
                                    <h6>Alamat</h6>
                                    <p> Jl Imogiri Barat Km 7.5  
                                        <br> Bangunharjo, Sewon, Bantul
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="contact-center bg-info">OR</p>
                </div>
            </div>
        </div>
    </section>
