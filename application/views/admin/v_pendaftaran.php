<!--Counter Inbox-->
<?php
    $query=$this->db->query("SELECT * FROM tbl_pendaftaran WHERE id_pendaftaran='1'");
...
<head>
  ...
  <title>MUSEBA | Pendaftaran</title>
...
<div class="wrapper">
              ...
              <table id="example1" class="table table-striped" style="font-size:12px;">
				...
				<?php
					$no=0;
  					foreach ($data->result_array() as $i) :
                       ...
                       $tgl_pendaftaran=$i['tgl_pendaftaran'];
                ...
                <tr>
                  ...
                  <td style="text-align:right;">
                        <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $id_pendaftaran;?>"><span class="fa fa-trash"></span></a></td>
                  <td><?php echo anchor('admin/pendaftaran/detail_pendaftaran/' .$id_pendaftaran,'<div class= "btn"><i class= "fa fa-print"</div></i>');?>
                </tr>
				<?php endforeach;?>
                </tbody>
              </table>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 <a href="http://mfikri.com">M Fikri</a>.</strong>
    <strong>Developer &copy; 2021 <a href="https://www.elrahmajogja.net/">STMIK EL RAHMA</a>.</strong> All rights reserved.
  </footer>
